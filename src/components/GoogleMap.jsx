...
class GoogleMap extends Component {
    ...
    async componentWillReceiveProps({isScriptLoaded, isScriptLoadSucceed, googleInitMap, updateRadius, marker}) {
...
export default scriptLoader(['https://maps.googleapis.com/maps/api/js?key=AIzaSyCWrFyrqGWvGwlZFOFIpE-AF-AeQfitG-8'])(GoogleMap);
